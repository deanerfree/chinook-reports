...
config :chinook_reports, ChinookReportsWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/chinook_reports_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :chinook_reports, dev_routes: true
...
config :chinook_reports, ChinookReports.ExcelExtractor,
  script_path: Path.expand("../priv/scripts/python/extract_all.py", __DIR__)
