defmodule ChinookReportsWeb.Icons do
  ...
  def link_icon(assigns) do
    ...
    >
      <path
        ...
        d="M13.19 8.688a4.5 4.5 0 0 1 0 6.364l-1.757 1.757a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-2.122a4.5 4.5 0 0 0-6.364 0l-1.757 1.757a4.5 4.5 0 0 0 0 6.364"
      />
    </svg>
    """
  end
  ...
  def pencil_square_icon(assigns) do
    ~H"""
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
